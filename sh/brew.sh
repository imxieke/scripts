...
if [[ "$(curl -sSL https://api.xie.ke/api/ip/country)" == 'CN' ]]; then
  HOMEBREW_BREW_DEFAULT_GIT_REMOTE="https://gitee.com/mirr/brew"
  HOMEBREW_CORE_DEFAULT_GIT_REMOTE="https://gitee.com/mirr/homebrew-core"
else
